...
import { CodeSmithError as SwiftCoderAIError } from "./errors.js";
...
export class ToolExecutor {
  ...
  async execute(call: ToolCall): Promise<string> {
    ...
    } catch (error) { return JSON.stringify({ error: error instanceof Error ? error.message : "Tool execution failed." }); }
  }
